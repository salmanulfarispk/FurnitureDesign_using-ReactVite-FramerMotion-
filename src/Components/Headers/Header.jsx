    ...
    return (
        <div className='mx-auto pt-16'>
            <div className=' sm:grid-cols-1 grid grid-cols-2 justify-items-center items-center'>
                ...
                <div className='sm:w-full sm:pl-4 w-4/5 pl-2'>
                    ...
                    <h1 className={
                        theme ==="light" ?
                        'sm:text-3xl text-4xl font-serif font-medium no-underline align-middle tracking-wide normal-case leading-normal text-dark':
                        'sm:text-3xl text-4xl font-serif font-medium no-underline align-middle tracking-wide normal-case leading-normal text-white'
                    }>
                    
                      Axel Brand new {" "}<span className={
                          theme==="light" ?
                        'sm:text-4xl text-dark text-5xl font-petitFormal font-bold' :
                        'sm:text-4xl text-white text-5xl font-petitFormal font-bold'
                        }
            ...
            >
              Modern Design
                    ...
                    <motion.img
                        className='sm:h-[475px] h-[665px] w-full bg-no-repeat bg-center relative z-10 rounded-xl'
                        src={header1}
                        alt='header-phone'
                        animate={{
                            y: [-20, 20, -20],
